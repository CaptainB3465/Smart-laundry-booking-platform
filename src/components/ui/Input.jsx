...
export const Input = React.forwardRef(({
  ...
  return (
    <div className="flex flex-col mb-4">
      {label && <label className="text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">{label}</label>}
      <input
        ref={ref}
        type={type}
        className={`
          px-4 py-2.5 bg-white dark:bg-slate-800 border rounded-lg text-slate-900 dark:text-white
